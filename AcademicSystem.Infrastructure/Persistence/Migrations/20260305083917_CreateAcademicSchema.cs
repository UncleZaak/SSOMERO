...
{
    /// <inheritdoc />
    public partial class CreateAcademicSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcademicYear = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AcademicClasses_Programmes_ProgrammeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Announcements_AcademicClasses_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enrollments_AcademicClasses_ClassId",
                        column: x => x.ClassId,
                        principalTable: "AcademicClasses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassCourses_AcademicClasses_ClassId",
                        column: x => x.ClassId,
                        principalTable: "AcademicClasses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClassCourses_Users_LecturerId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ClassCourseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assessments_ClassCourses_ClassCourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicClasses_ProgrammeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assessments_ClassCourseId",
                table: "Assessments",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Enrollments_Student_Class",
                table: "Enrollments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_NormalizedEmail",
                table: "Students",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_AssessmentId_StudentId",
                table: "Submissions",
