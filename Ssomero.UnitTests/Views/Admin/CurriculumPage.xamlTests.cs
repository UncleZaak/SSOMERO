...
/// <summary>
/// Unit tests for the <see cref="CurriculumPage"/> class.
/// </summary>
[TestClass]
public partial class CurriculumPageTests
{
    /// <summary>
    ...
    /// </summary>
    [TestMethod]
    public void CurriculumPage_WithValidViewModel_SetsBindingContextCorrectly()
    {
        // Arrange
        var mockViewModel = new Mock<CurriculumViewModel>(
            Mock.Of<IAcademicService>(),
            Mock.Of<IRefreshCoordinator>(),
            Mock.Of<ILogger<CurriculumViewModel>>());

        // Act
        var page = new CurriculumPage(mockViewModel.Object);
    ...
    /// </summary>
    [TestMethod]
    public void CurriculumPage_WithNullViewModel_SetsBindingContextToNull()
    {
        // Arrange
        CurriculumViewModel nullViewModel = null!;

        // Act
        var page = new CurriculumPage(nullViewModel);
    ...
    /// </summary>
    private class TestableCurriculumPage : CurriculumPage
    {
        public TestableCurriculumPage(CurriculumViewModel vm) : base(vm)
        {
        }
